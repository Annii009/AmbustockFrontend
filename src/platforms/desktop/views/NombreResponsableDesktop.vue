        ...
        <div class="step-card__body">
          ...
          <div class="autocomplete">
            <div class="input-wrap">
              <input type="text" v-model="nombre" class="field-input" placeholder="Nombre del responsable del servicio"
                autocomplete="off" @keyup.enter="continuar" @blur="closeSugerencias" />
              <span v-if="searching" class="spinner" />
            </div>
            <ul v-if="showList" class="sugerencias">
              <li v-for="(s, i) in sugerencias" :key="i" class="sugerencias__item" @mousedown.prevent="pick(s)"
                v-html="highlight(s, nombre.trim())" />
            </ul>
          </div>
          <div class="btn-row">
