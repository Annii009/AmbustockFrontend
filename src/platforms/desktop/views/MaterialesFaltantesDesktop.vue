    ...
    <div class="page">
      ...
      <div class="page__header">
        ...
        <div>
          ...
          <p class="page__sub">
            Se encontraron <strong>{{ cantidadFaltantes }}</strong> deficiencia{{ cantidadFaltantes !== 1 ? 's' : '' }}
      ...
      <!-- Tabla con campos: nombreProducto, cantidadFaltante, ubicacion -->
      <div v-else class="faltantes-table">
        ...
        <div v-for="(material, index) in materialesFaltantes" :key="index" class="faltantes-table__row">
...
//guardar Revisión y luego navegar
