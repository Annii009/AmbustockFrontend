          ...
          <div class="card">
            ...
            <div class="field">
              ...
              <div class="autocomplete-field">
                <input v-model="searchServicio" type="text" class="field__input" placeholder="Buscar servicio..."
                ...
                <ul v-if="showServicioAutocomplete && serviciosFiltrados.length" class="autocomplete-list">
                  <li v-for="s in serviciosFiltrados" :key="s.idServicio" class="autocomplete-list__item"
            ...
            <div class="field">
              ...
              <div class="autocomplete-field">
                <input v-model="nombreResponsable" type="text" class="field__input" placeholder="Nombre del responsable"
                ...
                <ul v-if="mostrarSugerenciasResponsable" class="autocomplete-list">
                  <li v-for="(s, i) in sugerenciasResponsable" :key="i" class="autocomplete-list__item"
                    @mousedown.prevent="seleccionarResponsable(s)" v-html="highlight(s, nombreResponsable.trim())" />
                </ul>
              </div>
            </div>
          </div>
        ...
        <div class="form-col">
          <div class="card">
            ...
            <div class="field">
              ...
              <div class="autocomplete-field">
                <input v-model="searchMaterial" type="text" class="field__input" placeholder="Buscar material..."
                ...
                <ul v-if="showMaterialAutocomplete && materialesFiltrados.length" class="autocomplete-list">
                  <li v-for="m in materialesFiltrados" :key="m.idMaterial" class="autocomplete-list__item"
                    @mousedown.prevent="agregarMaterial(m)">
                    {{ m.nombreProducto }}
                  </li>
                </ul>
              </div>
...
.field__select {
  ...
  &:focus {
    ...
    box-shadow: 0 0 0 3px rgba($primary-red, 0.06);
  }
}
