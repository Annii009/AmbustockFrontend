...
.action-item {
  ...
  border-radius: 10px; border: 1px solid $border-color; background: $white;
  cursor: pointer; transition: border-color 0.15s, background 0.15s;
  text-align: left;
  &:hover { border-color: $primary-red; background: rgba($primary-red, 0.02); }
}
...
.action-item__icon {
  ...
  &--blue  { background: $blue-accent; }
  &--red   { background: $primary-red; }
  &--green { background: $green-accent; }
}

.action-item__text { flex: 1; }
.action-item__name { font-family: $font-primary; font-size: 14px; font-weight: $font-bold; color: $text-dark; }
.action-item__sub  { font-family: $font-primary; font-size: 12px; color: $text-gray; margin-top: 1px; }
.action-item__arrow { width: 16px; height: 16px; color: $text-gray; flex-shrink: 0; }

.admin-profile { display: flex; align-items: center; gap: 0.875rem; margin-bottom: 1.25rem; }

.admin-avatar {
  width: 48px; height: 48px; border-radius: 50%; background: $primary-red;
  display: flex; align-items: center; justify-content: center; flex-shrink: 0;
  span { font-family: $font-display; color: $white; font-size: 18px; letter-spacing: 0.04em; }
}

.admin-name { font-family: $font-display; font-size: 18px; letter-spacing: $font-display-spacing; color: $text-dark; line-height: 1; margin-bottom: 4px; }

.admin-badge {
  font-family: $font-primary; font-size: 11px; font-weight: $font-semibold;
  color: $primary-red; background: rgba($primary-red, 0.08);
  padding: 0.15rem 0.5rem; border-radius: $border-radius-pill;
}

.info-rows { border: 1px solid $border-color; border-radius: 10px; overflow: hidden; margin-bottom: 1rem; }

.info-row {
  display: flex; flex-direction: column; gap: 2px;
  padding: 0.5625rem 0.875rem; border-bottom: 1px solid $border-color;
...
.btn-logout {
  ...
  padding: 0.625rem 0.75rem; background: $bg-page; border: 1px solid $border-color;
  border-radius: 9px; font-family: $font-primary; font-size: 13.5px; font-weight: $font-semibold;
  color: $text-dark; cursor: pointer; transition: all 0.15s;
  svg { width: 16px; height: 16px; opacity: 0.5; }
  &:hover { background: rgba($primary-red, 0.06); color: $primary-red; border-color: $primary-red; }
}
</style>