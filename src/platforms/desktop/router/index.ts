/**
 * index.ts — Router unificado mobile + desktop
 *
 * Las rutas son ÚNICAS. En función del ancho de pantalla,
 * se carga el componente mobile o desktop correspondiente.
 * Login y Register siempre usan la vista mobile (por diseño).
 */
...
const routes = [
  ...
  {
    // Login/Register → misma vista en ambos (mobile)
    path: '/login',
    name: 'login',
  ...
  // ── Área privada ─────────────────────────────────────────────────────────────
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { requiresAuth: true },
        component: adaptive(
          () => import('@mobile/views/VerRevisionesView.vue'),
          () => import('@desktop/views/VerRevisionesDesktop.vue')
        )
      },
      {
        ...
        meta: { requiresAuth: true },
        component: adaptive(
          () => import('@mobile/views/DetalleReposicionView.vue'),
          () => import('@desktop/views/DetalleReposicionDesktop.vue')
        )
      },
